...
COMMENT ON TABLE MOBILE.CS_SLICE IS '—писок конкурентных срезов';
...
COMMENT ON TABLE MOBILE.CS_SLICE_PR IS '«аписи ответственного точки о конкурентах точки, в конкурентном срезе';
